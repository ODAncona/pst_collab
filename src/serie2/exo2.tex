\begin{exo}
  ...
  \begin{subexo}{Calculer la probabilité que l'alarme retentisse un jour donné.}
    ...
    \end{tikzpicture}
    \begin{flushleft}
      La probabilité que l'alarme retentisse $P(A)$ est la probabilité qu'elle retentisse s'il y a un incendie ainsi que la probabilité qu'elle sonne une fausse alerte. Cela peut se traduire par: $P(A) = P(A \cap I) + P(A \cap \conj{I})$ Calculons
  	\end{flushleft}
    \begin{align*}
    \\P(A \cap I) &= P(A | I) \cdot P(I) =\dfrac{5}{1000} \cdot \dfrac{95}{100} = \dfrac{19}{4000}
    \\P(A \cap \conj{I}) &= P(A | \conj{I}) \cdot P(\conj{I}) = \dfrac{995}{1000} \cdot \dfrac{1}{100} = \dfrac{199}{20000}
    \end{align*}
	\begin{flushleft}
