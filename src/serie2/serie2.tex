...
\begin{document}
	...
	\begin{exo}
		...
		De manière similaire, $P(\conj{F}\cap G|\conj{E}) = P(\conj{F}|\conj{E}) \cdot P(G|\conj{E}) = \frac{1}{50} \cdot \frac{19}{20} = 0,019$
		\\
		De manière similaire, $P(F\cap \conj{G}|\conj{E}) = P(F|\conj{E}) \cdot P(\conj{G}|\conj{E}) = \frac{49}{50} \cdot \frac{1}{20} = 0,049$
		\end{flushleft}
		\end{subexo}
	\end{exo}
